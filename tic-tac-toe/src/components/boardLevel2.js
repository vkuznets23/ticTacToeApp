...
const BoardLvl2 = ( {currentPlayer, setCurrentPlayer }) => {
    ...
    const checkWinner = (newBoard) => {
        for (let pattern of winPattern) {
            const [a, b, c, d] = pattern; // Destructure pattern into variables
            if (newBoard[a] && newBoard[a] === newBoard[b] && newBoard[b] === newBoard[c] && newBoard[c] === newBoard[d]) {
    ...
    const handleClosePopup = () => {
        ...
        setBoard(Array(16).fill(null)); // Сбрасываем доску
